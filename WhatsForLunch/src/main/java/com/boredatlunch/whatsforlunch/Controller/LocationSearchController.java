...
public class LocationSearchController {
	...
	public String searchByCity(Locale locale, final Model model, @ModelAttribute("locationSearchForm") LocationSearchForm locationSearchForm, @ModelAttribute("searchResults")Results searchResults) {
